...
<head>
	...
	<body>
		<section>
		    ...
		    <p>Merci, <strong><?=$nom?></strong>, pour votre réservation avec <strong><?=$id?></strong> comme identifiant.</p>
		    <p>Nous avons bien reçu votre demande pour le <strong><?=$date?></strong> à <strong><?=$heure?></strong>.</p>
